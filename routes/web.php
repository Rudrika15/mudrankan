...
Route::get('/walldecors', [HomeController::class, "walldecors"])->name("front_end.walldecors");
Route::get('/cartcode/{id}', [HomeController::class, "cartcode"])->name("front_end.cartcode");
...
Route::get('/remove_from_cart', [HomeController::class, "cartdelete"])->name("front_end.remove_from_cart");
...
Route::post("addressedit", [HomeController::class, 'addressedit'])->name('front_end.addressedit');
//payment
...
Route::group(['/backend/middleware' => ['auth', 'permission']], function () {
  ...
  Route::post("/backend/users/update/{user}", [UsersController::class, "update"])->name('users.update');
