...
<body>
        ...
        <ul class="navbar-nav me-5">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item " href="{{ route('logout') }}" class="btn btn-outline-dark me-2"> Logout</a></li>
            </ul>
          </li>
        </ul>
      </div>
  ...
  <div class="sidebar bg-light">
    <div class="border border-4" style="font-weight: 500; color: gray; font-size: 180%;"><i class="bi bi-cart4"></i> E-commerce</div>
    ...
    <div><a href="{{route('category.show',app()->getLocale())}}"><i class="bi bi-folder-fill"></i> {{__('Category')}}</a></div>
    ...
    <div><a href="{{route('optiongroup.show')}}"> <i class="bi bi-plus-square-fill"></i> {{__('Option Group')}}</a></div>
    <div><a href="{{route('coupon.show')}}"><i class="bi bi-ticket-detailed"></i> {{__('Coupon')}}</a></div>
    <div> <a href="{{route('voucharmaster.show')}}"><i class="bi bi-ticket-detailed-fill"></i> {{__('Vouchar')}}</a></div>
