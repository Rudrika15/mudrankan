...
<div class="container mt-3">
  ...
  @if ($message = Session::get('success'))
    ...
    <div class="d-flex flex-row-reverse">
      <a href="{{route('slide.show')}}" class="btn btn-primary">{{__('Back')}} </a>    
    </div>
@if ($errors->any())
...
@endif
  <form action="{{url('backend/slide/code')}}" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 mt-3">
      ...
      <input type="text" class="form-control" id="text_position" placeholder="{{__('Enter text position')}}" name="text_position">
    </div>
    <div class="mb-3 mt-3">
      <label for="text_color">{{__('Text Color')}}:</label>
      <input type="text" class="form-control" id="text_color" placeholder="{{__('Enter text color')}}" name="text_color">
    </div>
    <div class="mb-3 mt-3">
      <label for="button_color">{{__('Button Color')}}:</label>
      <input type="text" class="form-control" id="button_color" placeholder="{{__('Enter button color')}}" name="button_color">
    </div>
    <div class="mb-3 mt-3">
      <label for="background_color">{{__('Background Color')}}:</label>
      <input type="text" class="form-control" id="background_color" placeholder="{{__('Enter background color')}}" name="background_color">
    </div>
    <div class="mb-3 mt-3">
      <label for="indicator_color">{{__('Indicator Color')}}:</label>
      <input type="text" class="form-control" id="indicator_color" placeholder="{{__('Enter indicator color')}}" name="indicator_color">
    </div>
